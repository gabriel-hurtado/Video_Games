...
public class OrderlineHome {
	...
	public Orderline findById(OrderlineId id) {
		...
		try {
			Orderline instance = (Orderline) sessionFactory.getCurrentSession().get("Orderline", id);
			if (instance == null) {
	...
	public List<Orderline> findByExample(Orderline instance) {
		log.debug("finding Orderline instance by example");
		try {
			List<Orderline> results = (List<Orderline>) sessionFactory.getCurrentSession().createCriteria("Orderline")
